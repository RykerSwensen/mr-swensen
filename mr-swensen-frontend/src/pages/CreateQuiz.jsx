                                                    ...
                                                    {inputFields.map(inputField => (
                                                        <div key={inputField.id}>
                                                            <textarea
                                                                ...
                                                                style={{ padding: "5px", fontSize: "16px", fontWeight: "500", color: "black", marginLeft: 150 }}
                                                            />

                                                            <Label style={{ verticalAlign: "top", color: "#EEEEEE" }} htmlFor="correct">Correct:</Label>
                                                            <input style={{ verticalAlign: "top", color: "#EEEEEE", width: 18 }} type="radio" name='correct' value={inputField.option} onClick={(e) => setCorrectOption(e.target.value)} />

  ...
  return (
    <>
      ...
      <Container>
        <Wrapper>
          <Popup
            trigger={<CreateButton >Add a new subject! </CreateButton>}
            modal
            nested
          >
            {close => (
              <div style={{ fontSize: "32px", backgroundColor: "#393E46", width: "400px"}}>
          ...
          <TableContainer component={Paper}>
            <Table sx={{ minWidth: 650, fontSize: 30,  color: "#FFFFFF" }} aria-label="simple table">
              <TableHead>
                <TableRow style={{  color: '#ffffff' }}>
                  <TableCell sx={{ fontSize: 20, }}>Subject Quizzes</TableCell>
